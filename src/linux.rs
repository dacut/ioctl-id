...
pub const IOC_NRMASK: IoctlId = (1 << IOC_NRBITS) - 1;
...
pub const IOC_TYPEMASK: IoctlId = (1 << IOC_TYPEBITS) - 1;
...
pub const IOC_SIZEMASK: IoctlId = (1 << IOC_SIZEBITS) - 1;
...
pub const IOC_DIRMASK: IoctlId = (1 << IOC_DIRBITS) - 1;
...
pub const fn ioc(dir: IoctlId, r#type: IoctlId, nr: IoctlId, size: IoctlId) -> IoctlId {
...
pub const fn io(r#type: IoctlId, nr: IoctlId) -> IoctlId {
...
pub const fn ior<T>(r#type: IoctlId, nr: IoctlId) -> IoctlId {
    ioc(IOC_READ, r#type, nr, size_of::<T>() as IoctlId)
}
...
///
/// Reference: [`include/uapi/asm-generic/ioctl.h`](https://github.com/torvalds/linux/blob/7c16f0a4ed1ce7b0dd1c01fc012e5bde89fe7748/include/uapi/asm-generic/ioctl.h#L86)
pub const fn iow<T>(r#type: IoctlId, nr: IoctlId) -> IoctlId {
    ioc(IOC_WRITE, r#type, nr, size_of::<T>() as IoctlId)
}
...
pub const fn iowr<T>(r#type: IoctlId, nr: IoctlId) -> IoctlId {
    ioc(IOC_READ | IOC_WRITE, r#type, nr, size_of::<T>() as IoctlId)
}
...
pub const fn ioc_dir(id: IoctlId) -> IoctlId {
...
pub const fn ioc_type(id: IoctlId) -> IoctlId {
...
pub const fn ioc_nr(id: IoctlId) -> IoctlId {
...
pub const fn ioc_size(id: IoctlId) -> IoctlId {
